...
The workspace directory (`session/<user>/workspace/`) serves as an Obsidian vault. Sync to other devices is done out-of-band (e.g. syncthing) — PawLia does not manage a git repo here.
